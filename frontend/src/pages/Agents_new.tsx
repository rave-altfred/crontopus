      ...
      <div className="bg-white dark:bg-[#44475a] rounded-lg shadow p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <button
            ...
            className="flex flex-col items-center p-6 border-2 border-gray-200 dark:border-[#6272a4] rounded-lg hover:border-blue-500 dark:hover:border-blue-400 hover:shadow-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <Terminal className="w-12 h-12 mb-3 text-blue-500" />
            <span className="font-semibold text-lg mb-1">Linux</span>
            <span className="text-sm text-gray-500 dark:text-[#6272a4] text-center mb-3">
